...
console.log(movies[1].genres.length -3);
...
if(movies[0].actors[1] == "Natalie Portman"){
  console.log(true);
}else{
  console.log(false);
}
...
// 27. Log the name of all the movies with more than 1 genre
  console.log(movies[0].genres[1][2]);
// 28. Log the name of all the movies with more than 1 actors
console.log(movies[0].actors[1][2]);

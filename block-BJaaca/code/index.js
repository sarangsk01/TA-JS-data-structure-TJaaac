...
character.greet = function() {
        alert(`I am Sarang and my title is object`);
...
character.greet = function() {
    alert(`She is Arya and her title is object`);
...
character.isAdult = age>=18 ? alert `true` : alert `false`;
...
console.log(`The key value is 42`);
